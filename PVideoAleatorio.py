...
def CalculaCentroidesIniciales(listaHist, K):
    ...
    for i in range(int(K)):
        nRandom = EscogeRandom(listaHist,listCentroides)
        
        listCentroides.append(listaHist[nRandom])
        listCentroides.append(listaHist[nRandom+1])
        listCentroides.append(listaHist[nRandom+2])
